...
class BadRequestException extends \Exception implements ApiExceptionInterface
{
    ...
    public function __construct(
        $message = StatusCodes::BAD_REQUEST_MESSAGE,
        $code = StatusCodes::BAD_REQUEST_CODE,
        \Throwable $previous = null,
        $debug = []
    )
    {
        $message = $message??StatusCodes::BAD_REQUEST_MESSAGE;
        $code = $code??StatusCodes::BAD_REQUEST_CODE;
