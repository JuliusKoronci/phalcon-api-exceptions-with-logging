...
class UnAuthorizedException extends \Exception implements ApiExceptionInterface
{
    ...
    public function __construct(
        $message = StatusCodes::UNAUTHORIZED_MESSAGE,
        $code = StatusCodes::UNAUTHORIZED_CODE,
        \Throwable $previous = null,
        $debug = []
    )
    {
        $message = $message??StatusCodes::UNAUTHORIZED_MESSAGE;
        $code = $code??StatusCodes::UNAUTHORIZED_CODE;
